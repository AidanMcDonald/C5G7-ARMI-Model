...
#groups = openmc.mgxs.EnergyGroups([1.0e-5, 1.00001e-5, 1.00002e-5,1.00003e-5, .99997e7, .99998e7, .99999e7, 1.0e7])

# Instantiate the 7-group C5G7 cross section data
uo2_xsdata = openmc.XSdata('fuel', groups)
uo2_xsdata.order = 0
...
mox43_xsdata = openmc.XSdata('mox low fuel', groups)
...
mox7_xsdata = openmc.XSdata('mox medium fuel', groups)
mox7_xsdata.order = 0
...
mox87_xsdata = openmc.XSdata('mox high fuel', groups)
...
fiss_chamber_xsdata = openmc.XSdata('fission chamber', groups)
...
guide_tube_xsdata = openmc.XSdata('guide tube', groups)
...
water_xsdata = openmc.XSdata('moderator', groups)
